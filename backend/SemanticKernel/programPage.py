...
class ProgramPagePlugin:
    ...
    def programPage(
        ...
        extraContext: dict = None
    ) -> List[ProgramGQLModel]:
        """
        Automaticaly generated skill for acces to graphql endpoint from sdl for Query.programPage.
        ...
        # return List["ProgramGQLModel"](**response.json()["data"]["programPage"])