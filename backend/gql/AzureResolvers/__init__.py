...
from .document_find import search_documents
from .document_delete import delete_documents_by_filter
from .document_fragment_delete import delete_document_fragment
from .document_fragment_update import update_document_folder_by_id_prefix
...
def searchdocumenthandler_(query: str):
...
def sumarize_(query: str, docs: list[dict]):
    ai_api_key     = getenv("OPENAI_API_KEY","")
